    ...
    <>
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-inter gap-[18px] items-start mx-auto md:pl-10 sm:pl-5 pl-[130px] w-full">
        <div className="flex flex-col gap-9 items-start justify-start md:mt-0 mt-[75px] p-12 md:px-10 sm:px-5 w-auto sm:w-full">
          ...
          <div className="flex flex-col md:gap-10 gap-[159px] items-center justify-start w-auto sm:w-full">
            <div className="flex flex-col gap-9 items-center justify-start w-auto sm:w-full">
              <Text
                className="text-black-900_07 text-lg w-[431px]"
                size="txtInterRegular18Black90007"
              >
                Enter your 4-digit card pin to confirm this payment
              </Text>
              <Img
                className="h-[52px] w-[272px]"
